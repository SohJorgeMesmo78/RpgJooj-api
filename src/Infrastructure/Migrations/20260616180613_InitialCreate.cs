    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoriasPersonagens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoriasPersonagens_Personagens_IdPersonagem",
